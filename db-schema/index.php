...
<center>
	...
	<table border="1" cellpadding="0">
		<tr><td valign="top" width="25%">
			<iframe frameborder="no" scrolling="yes"  width="100%" height="800" name="list" src="db.php" title="iFrame Test."></iframe>
		</td><td width="100%">
			<iframe frameborder="no" scrolling="yes"  width="100%" height="800" name="form" src="tables.php" title="iFrame Test."></iframe>
		</td></tr>
	</table>
</center>
</html>
